    ...
    <>
      ...
      {urlContains ? (
        <Modal
          ...
          centered
          className="wilphopy-modal wfh-video ISTH20"
        >
          <Modal.Header closeButton></Modal.Header>
          <Modal.Body>
            <div className="one_source_video">
              <ReactPlayer
                ...
                // }}
                // poster= {path_image + "isth-nuwiq-video-poster.jpg"}
                src="https://docintel.s3-eu-west-1.amazonaws.com/video/Haematology_Octapharma/161717581139705.mp4"
                controls={true}
                width="640"
                height="360"
